 ...
 */
public final class MantisRunnerRegistrar {
    private MantisRunnerRegistrar() {}

    /** Registers the {@link MantisRunner}. */
    @AutoService(PipelineRunnerRegistrar.class)
    public static class Runner implements PipelineRunnerRegistrar {
        @Override
        public Iterable<Class<? extends PipelineRunner<?>>> getPipelineRunners() {
            return Collections.singletonList(MantisRunner.class);
        }
    }

    /** Registers the {@link MantisPipelineOptions}. */
    @AutoService(PipelineOptionsRegistrar.class)
    public static class Options implements PipelineOptionsRegistrar {
        @Override
        public Iterable<Class<? extends PipelineOptions>> getPipelineOptions() {
            return Collections.singletonList(MantisPipelineOptions.class);
        }
    }
}
